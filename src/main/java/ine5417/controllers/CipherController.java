...
public class CipherController {
     ...
     */
    public Ciphered encrypt(String plaintext, String cipher, String key) {
     ...
     */
    public Deciphered decrypt(String encrypted, String cipher, String key) {
        Algorithm algorithm = getAlgorithm(cipher);
     ...
     */
    public BruteForceResult bruteforce(String encrypted, String cipher) {
        Algorithm algorithm = getAlgorithm(cipher);
     ...
     * @throws InvalidCipherException If no algorithm with the given identifier is found.
     */
    public Algorithm getAlgorithm(String cipher) throws InvalidCipherException {
        Optional<Algorithm> algorithm = AlgorithmFactory.getAlgorithm(cipher.toLowerCase());

        if (algorithm.isEmpty()) {
            throw new InvalidCipherException("Invalid cipher: " + cipher);
        }
